...
void display(){
  ...
  // Clear the area where the soil moisture is displayed
tft.fillRect(190, 150, 60, 30, ILI9341_WHITE); // adjust width and height as needed
...
double calcSoilValue(){    
  ...
  conVal = map(soilVal, 1500, 3000, 100, 0);
  if (conVal < 0)
  {
    conVal = 0;
  }
